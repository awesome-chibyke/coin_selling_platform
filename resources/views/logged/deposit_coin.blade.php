                ...
                <div class="card mt-4">
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-6 mb-md-0 mb-4 text-center triggerPaymentProcedure" style="margin-top: 10px;" data-coin-name="{{ $eachCoinDetail->name }}" data-coin-code="{{ $eachCoinDetail->code }}">
                            <div class="image_for_coins_carrier">
                                ...
                                <div class="text-small text-muted">{{ $eachCoinDetail->code }} {{ $eachCoinDetail->code === 'USDTBSC' ? '(BEP20)':''}}</div>
                            </div>
                        </div>
                        @endforeach
                    </div>
