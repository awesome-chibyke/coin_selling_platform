...
$title = 'Login | Convert your cryptocurrencies to Naira at an affordable rate';
                    ...
                    <div class="woocommerce"><div class="woocommerce-notices-wrapper"></div>
                        <form enctype="multipart/form-data" class="woocommerce-form woocommerce-form-login login" method="post">
                            ...
                            <p class="woocommerce-LostPassword lost_password">
                                <a href="forgot-password">Lost your password?</a> <br><br>
                                <a class="text-primary" href="register">Don't have an account? <u>Register</u></a>
                            </p>
                        </form>
                    </div>
                </div>
