<div id="marquee" style="width: 100%; padding-top: 5px; background-color: #000;">
    <marquee direction="center" onmouseover="this.stop()" onmouseout="this.start()"><ul style="display: inline-flex; padding: 0px; margin: 0px; list-style: none; color: #fff;"><ul style="display: inline-flex; padding: 0px; margin: 0px; list-style: none; color: #fff;">
...
<nav style="padding-top: 30px;" id="pr-nav" class="primary-menu navbar navbar-expand-lg navbar-dark nav-black-desktop">
    ...
    <div class="container primary-menu-inner ">
            ...
            <div class="top-wrap">
            <a class="custom-logo-link" href="./"><h5 class="m-0"><img width="150" src="img/dataseller-logo-main.png"></h5></a>            <button id="mobile-toggle" class="navbar-toggler animate-button collapsed" type="button" data-toggle="collapse" data-target="#navbarColor01" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <ul id="primary-menu" class="navbar-nav pl-3" itemscope="">
                ...
                <li id="menu-item-1868" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-1868 nav-item"><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link" id="menu-item-dropdown-1868"><span itemprop="name">Accounts</span></a>
                    <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-1868">
                        ...
                        <li id="menu-item-1879" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1879 nav-item"><a itemprop="url" href="logout" class="dropdown-item"><span itemprop="name">Logout</span></a></li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="header-cta"><a href="login" target="_blank"><div class="d-inline-block elementor-button-link elementor-button elementor-size-md">Fiat Rate ₦600/$</div></a></div>        </div>
