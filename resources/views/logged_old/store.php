                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list nk-tb-ulist">
                                <div class="nk-tb-item nk-tb-head">
                                    ...
                                    <div class="nk-tb-col tb-col-mb"><span class="sub-text">Beneficiary Name</span>
                                    </div>
                                ...
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col">
                                        <a href="html/user-details-regular.html">
                                            <div class="user-card">
                                                ...
                                                <div class="user-info">
                                                    <span class="tb-lead">{{ $eachBankDetails->bank_name }} <span
                                    ...
                                    <div class="nk-tb-col">
                                        <a href="html/user-details-regular.html">
                                            <div class="user-card">
                                                <div class="user-info">
                                                    <span class="tb-lead">{{ $eachBankDetails->beneficiary_name }} <span
                                                            class="dot dot-success d-md-none ml-1"></span></span>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="nk-tb-col tb-col-md">
                                        @php $statusDetails = $eachBankDetails->getStatus($eachBankDetails->status)
                                        @endphp
                                        <span
                                            class="tb-status text-{{ $statusDetails->class }}">{{ $statusDetails->keyword }}</span>
                                    </div>
                                            ...
                                            <li>
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a
                                                                    href="{{ route('activate-bank', [$eachBankDetails->unique_id]) }}"><em
                                                                        class="icon ni ni-eye"></em><span>Make
                                                                        Active</span></a></li>
                                                            <li><a
                                                                    href="{{ route('delete-bank', [$eachBankDetails->unique_id]) }}"><em
